...
## [0.9.0] - 14.10.2025
    ...
    - Plugins&Addons Extensions support
    - Page Manager settings update
    - Sidebar toggle by gestures.
    - Compact mode by gestures.
    - Translations can be broken before update v1.0.0

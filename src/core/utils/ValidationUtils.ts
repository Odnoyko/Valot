...
export class ValidationUtils {
     ...
     */
    static validateNumber(value: number, rules: ValidationRules): ValidationResult {
        // Required check
     ...
     */
    static validateHourlyRate(rate: number): ValidationResult {
     ...
     */
    static validateDuration(minutes: number): ValidationResult {
     ...
     */
    static validatePercentage(value: number): ValidationResult {

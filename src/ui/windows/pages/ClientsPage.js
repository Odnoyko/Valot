...
import { getCurrencySymbol, getAllCurrencies } from 'resource:///com/odnoyko/valot/data/currencies.js';
import { WidgetFactory } from '../../utils/widgetFactory.js';
import { BUTTON, HEADING, MESSAGE, LABEL, PLACEHOLDER, TOOLTIP, EMPTY_STATE, LOADING, ERROR } from 'resource:///com/odnoyko/valot/ui/utils/commonStrings.js';
...
export class ClientsPage {
    ...
    getWidget() {
        ...
        const statusPage = new Adw.StatusPage({
            title: _('Clients'),
            description: _('Client management - UI migration in progress'),

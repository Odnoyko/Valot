...
export class ClientsPage {
    ...
    async loadClients() {
        ...
        try {
            ...
            const clients = await this.coreBridge.getClients();
    ...
    _createClientRow(client) {
        ...
        const rateLabel = new Gtk.Label({
            label: `${client.currency || '$'}${(client.rate || 0).toFixed(2)}/hr`,
            css_classes: ['rate-display', 'monospace', 'dim-label'],
            valign: Gtk.Align.CENTER,
     ...
     */
    showAddClientDialog() {
        // TODO: Implement dialog via Core
        console.log('Add client dialog');
    }
